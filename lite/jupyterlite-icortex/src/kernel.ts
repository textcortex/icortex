...
import { PIPLITE_WHEEL } from '@jupyterlite/pyolite-kernel/lib/_pypi';

/**
 * A kernel that executes Python code with Pyodide.
 */
export class ICortexKernel extends BaseKernel implements IKernel {
  /**
   * Instantiate a new PyodideKernel
   *
   * @param options The instantiation options for a new PyodideKernel
   */
  constructor(options: ICortexKernel.IOptions) {
    super(options);
   ...
   * @param options The instantiation options for a new PyodideKernel
   */
  protected buildWorkerScript(options: ICortexKernel.IOptions): string[] {
...
/**
 * A namespace for ICortexKernel statics.
 */
export namespace ICortexKernel {
  /**
